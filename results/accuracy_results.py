...
def get_log_dir(experiment_dir: bytes,
                experiment_name: bytes,
                experiment_n: bytes) -> str:
    ...
    for model_name in model_names:
        for model_version in model_versions:
            ...
            try:
                ...
                checkpoint_file_name = get_checkpoint_file_names(checkpoint_dir)[0]

                epoch = get_epoch_from_checkpoint_file(checkpoint_file_name)
